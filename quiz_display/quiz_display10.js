...
function loadQuestion() {
    ...
    questionElement.textContent = "問題 " + (currentQuestionIndex + 91) + ": " + currentQuestion.question;
...
function showResult() {
    ...
    choicesElement.innerHTML = "";
        ...
        for (let i = 0; i < questions.length; i++) {
            ...
            result.textContent = "問題 " + (i + 91) + ": 問題文: " + currentQuestion.question + (isCorrect ? " ○ " : " × ") + " 正解は「" + currentQuestion.correctAnswer + "」です。";
