...
import questions from "../quiz_data/quiz_data9.js";
...
function loadQuestion() {
    ...
    questionElement.textContent = "問題 " + (currentQuestionIndex + 81) + ": " + currentQuestion.question;
...
function showResult() {
    ...
    choicesElement.innerHTML = "";
        ...
        for (let i = 0; i < questions.length; i++) {
            ...
            result.textContent = "問題 " + (i + 81) + ": 問題文: " + currentQuestion.question + (isCorrect ? " ○ " : " × ") + " 正解は「" + currentQuestion.correctAnswer + "」です。";
